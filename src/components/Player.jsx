...
const VolumeControl = () => {
    ...
    const silencedVolume = volume < 0.1
...
export function Player() {
    ...
    return (
        <div className="flex flex-row justify-between w-full px-4 z-50 text-white">
            ...
            <div className="grid place-content-center flex-1 gap-4">
                <div className="flex justify-center flex-col items-center">
                    <button className="bg-white rounded-full p-2 -mb-3 mt-2" onClick={handleClick}>
